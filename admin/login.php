...
require('DBConnect.php');
    ...
    if(isset($_SESSION["username"] , $_SESSION["password"])){
        ...
        if(isset($_POST['logbtn'])){
            if(isset($_POST['logun'] , $_POST['logpass'])){
                
                $username = $_POST['logun'] ;
...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Login | The Liver Foundation</title>
                                    ...
                                    <!-- col-lg-4 start here -->
                                        <div class="panel panel-default " style="border:0;">
                                            ...
                                            <div class="panel-heading" style=" background-color:rgba(155,32,97,.8);">
                                                ...
                                                <h3 class="panel-title" style="text-align:center; font-size:25px; color:white">Admin Login</h3>
                                            </div>
                                            ...
                                            <div class="alert alert-danger" role="alert" style="display:<?php echo $error;?>">
                                                ...
                                                <h4 id="subc"><i class="fa fa-user" style="color:#9b2061"></i></h4>
                                                <br>
                                                

                                                <form action="login.php" method="post" class="form-horizontal group-border stripped" role="form">

                                                    <div class="form-group">
                                                        
                                                        <div class="col-sm-12">
                                                            <input type="text" class="form-control" id="" placeholder="Enter Username" required name="logun">  
                                                        </div>

                                                        <hr>

                                                        <div class="col-sm-12">
                                                            <input type="password" class="form-control" id="" placeholder="Enter Password" style="margin-top:20px" required name="logpass"> 
                                                        </div>
                                                        ...
                                                        <div class="">
                                                            <button type="submit" class="btn btn-default " id="subcbtn" style="margin-top:30px;" name="logbtn"><i class="fa fa-key" aria-hidden="true" ></i> LOG ON</button>
                                                        </div>

                                                        <span style="margin-top:40px">Forgot <a href="forgotpassword.php" style="color: rgba(155,32,97,1)">Password?</a></span>
