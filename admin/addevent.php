...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Add Event | The Liver Foundation</title>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            ...
                            <div class="page-header">
                                <h2>Add Event Wizard</h2>
                                
                            </div>
                           
                        </div>
                        
                        <form action="postevent.php" method="post" class="form-horizontal group-border stripped" role="form">
