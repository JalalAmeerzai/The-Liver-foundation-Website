...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Update Monthly Stats Wizard | The Liver Foundation</title>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            ...
                            <div class="page-header">
                                <h2>Update Monthly Stats</h2>
                                
                            </div>
                           
                        </div>
                        
                        <form action="updatestats.php" method="post" class="form-horizontal group-border stripped" role="form">
