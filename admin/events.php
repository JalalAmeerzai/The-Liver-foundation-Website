                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            <div class="page-header">
                                <h2>Events</h2>
                                <span class="txt">Listing the information regarding events at TLF</span>
                            </div>
                                ...
                                <div class="panel panel-default plain panelRefresh">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div style="col-lg-4">
                                            ...
                                            <div style="col-lg-4">
                                                <a href="addevent.php"><button type="submit" class="btn btn-default" id="subcbtnyellow" style="float:right; margin:0 5px 15px 5px" > <i class="fa fa-plus"> </i> Add Event</button></a>
                                            </div>
                                        ...
                                        <table id="basic-datatables" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead >
                                                <tr style="background-color: rgba(155,32,97,1); color: white; ">
                                                    ...
                                                    <th title="item">S. No</th>
                                                    <th title="source">Event Title</th>
                                                    <th title="source id"> Added By</th>
                                                    <th title="source price">Add Date</th>
                                                    <th title="target">Update Date</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>123</td>
                                                    <td>World Hepatitis Day 2019</td>
                                                    <td>Mr. Bilal</td>
                                                    <td>2019/07/28</td>
                                                    <td>2019/07/29</td>
                                                    <td >
                                                        <div id="editDiv">
                                                            ...
                                                            <div id="btndiv" >
                                                                <a title="edit" href="editevent.php"><i class="fa fa-edit" id="tablebtns" style="background-color: #66BB6A; color:white" ></i></a>
                                                                <a title="delete"><i class="fa fa-trash-o" style="background-color: #EF5350; color:white" id="tablebtns" data-toggle="modal" data-target="#modal-style3"></i></a>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>321</td>
                                                    <td>Free Hepatitis Camp 2018</td>
                                                    <td>Mr. Bilal</td>
                                                    <td>2018/07/18</td>
                                                    <td>2018/08/19</td>
                                                    <td >
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                    ...
                                                    <a href="delevent.php"><button  class="btn btn-default col-lg-4" id="delgreen" style="width:100%">Yes, delete the information</button></a>
