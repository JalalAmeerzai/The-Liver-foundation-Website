...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Admin Settings | The Liver Foundation</title>
            ...
            <div class="page-content sidebar-page right-sidebar-page clearfix">
                ...
                <div class="page-content-wrapper">
                    <div class="page-content-inner">
                        ...
                        <form action="updateuser.php.php" method="post" class="form-horizontal group-border stripped" role="form">
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                <p> <i class="fa fa-user" style="font-size:20px;">  </i> User General Settings</p>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Username</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="" placeholder="eg: TLFAdmin123">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="Email" class="form-control" id="" placeholder="eg: John Doe">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Email Address</label>
                                    <div class="col-sm-12">
                                        <input type="Email" class="form-control" id="" placeholder="eg: admin@liverfoundationpk.com">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button type="submit" class="btn btn-default" id="subcbtn" >Update Information</button>
                                    </div>
                                </div>
                        ...
                        <form action="updateuser.php.php" method="post" class="form-horizontal group-border stripped" role="form">
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Current Password</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">New Password</label>
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" id="" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Repeat Password</label>
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" id="" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button type="submit" class="btn btn-default" id="subcbtn" >Change Password</button>
                                    </div>
                                </div>
