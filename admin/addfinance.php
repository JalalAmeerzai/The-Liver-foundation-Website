<?php
    ...
    if(isset($_POST["financebtn"])){
        $query = "INSERT INTO finance VALUES(".$_POST["financeyear"]." , ".$_POST["trustreceipts"]." , ".$_POST["clinicreceipts"]." , ".$_POST["trustoperations"]." , ".$_POST["clinicoperations"].");";
...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Add Finance Wizard | The Liver Foundation</title>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            ...
                            <div class="page-header">
                                <h2>Add Finance Information</h2>
                                
                            </div>
                           
                        </div>
                        
                        <form action="addfinance.php" method="post" class="form-horizontal group-border stripped" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="" placeholder="eg: 2019" required name="financeyear">
                                </div>
                            </div>
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="trustreceipts">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="clinicreceipts">
                                    </div>
                                </div>
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="trustoperations">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="clinicoperations">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="subcbtn" style="width:100%" name="financebtn">Add Information</button>
                                </div>
                            </div>
