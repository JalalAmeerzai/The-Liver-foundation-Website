...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Add Monthly Stats Wizard | The Liver Foundation</title>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            ...
                            <div class="page-header">
                                <h2>Add Monthly Stats</h2>
                                
                            </div>
                           
                        </div>
                        
                        <form action="poststats.php" method="post" class="form-horizontal group-border stripped" role="form">

                        <div class="form-group">
                                <label for="" class="col-sm-12 control-label">Year</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="" placeholder="eg: 2019">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label">Month</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Screening for Hep 'B' and 'C'</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 23">
                                    </div>
                            </div>

                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Hepatitis 'B' Patients Treated</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 23">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Hepatitis 'C' Patients Treated</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 23">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Hepatitis 'B' Patients Vaccinated</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 23">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Hepatitis 'C' Patients SVR</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 23">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Camps Conducted</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 4">
                                    </div>
                            </div>
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                <p> <i class="" style="font-size:20px;">  </i></p>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="subcbtn" style="width:100%">Add Information</button>
                                </div>
                            </div>
