...
$(document).ready(function() {
    ...
    var plans = ['Trial','Lite','Basic','Premium','Pro','Pro 3k','Pro 5k','Master','Master 10k','Master 15k','Expert','Expert 25K','Custom'];
    var listings = ['50 Listings','100 Listings / $10','250 Listings / $15','600 Listings / $25','1500 Listings / $40','3000 Listings / $60','5000 Listings / $80','7000 Listings / $90','10,000 Listings / $100','15,000 Listings / $110','20,000 Listings / $120','25,000 Listings / $130','For 25K+ listings please contact us'];
    
    
	$("#slider-show-val").on("slide", function(slideEvt) {
        
        $('#plan').text(plans[slideEvt.value]);
        $('#listings').text(listings[slideEvt.value]);
