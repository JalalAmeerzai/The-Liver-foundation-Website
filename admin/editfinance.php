<?php
    ...
    if(isset($_GET["year"])){
        ...
        if (mysqli_num_rows($result) == 1){
            ...
            $year = $row["finance_id"];
            $trustreceipts = $row["finance_trust_receipts"];
            $clinicreceipts = $row["finance_cinic_receipts"];
            $trustoperations = $row["finance_trust_operations"];
            $clinicoperations = $row["finance_cinic_operations"];
        }
        else{
        ...
        if(isset($_POST["financebtn"])){
            $query = "UPDATE finance SET finance_id=".$_POST["financeyear"]." , finance_trust_receipts=".$_POST["trustreceipts"]." , finance_cinic_receipts=".$_POST["clinicreceipts"]." , finance_trust_operations=".$_POST["trustoperations"]." , finance_cinic_operations=".$_POST["clinicoperations"]." WHERE finance_id=".$_POST["financeyear"].";";
            echo "<script>alert('$query');</script>";
            if (mysqli_query($connection, $query)){
                $messageSuccess = "block";

                $query = "SELECT * from finance WHERE finance_id =".$_POST["financeyear"]." ;";
                $result = mysqli_query($connection, $query);
...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Update Finance Wizard | The Liver Foundation</title>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div id="page-header" class="clearfix">
                            ...
                            <div class="page-header">
                                <h2>Update Finance Information</h2>
                                
                            </div>
                           
                        </div>
                        
                        <form action="editfinance.php?update=1" method="post" class="form-horizontal group-border stripped" role="form">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label">For Financial Year</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="" placeholder="eg: 2019" required name="financeyear" value="<?php echo $year;?>">
                                </div>
                            </div>

                            <br>

                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                <p> <i class="l-ecommerce-graph3" style="font-size:20px;">  </i> Receipts</p>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Trust Receipts</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="trustreceipts" value="<?php echo $trustreceipts;?>">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Clinic Receipts</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="clinicreceipts" value="<?php echo $clinicreceipts;?>">
                                    </div>
                                </div>
                            ...
                            <div class="bs-callout bs-callout-info mt0" style="border-left-color:rgba(155,32,97,1)">
                                <p> <i class="l-ecommerce-banknotes" style="font-size:20px;">  </i> Expenditures</p>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Trust Operations</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="trustoperations" value="<?php echo $trustoperations;?>">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="" class="col-sm-12 control-label">Clinic Operations</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="" placeholder="eg: 234512" required name="clinicoperations" value="<?php echo $clinicoperations;?>">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="subcbtn" style="width:100%" name="financebtn">Update Information</button>
                                </div>
                            </div>
